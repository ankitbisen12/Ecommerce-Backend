...
let transporter = nodemailer.createTransport({
  ...
  secure: false,
  auth: {
    user: 'ankitbisen751@gmail.com', //generate ethereal user
    pass: process.env.MAIL_PASSWORD, //process.env.MAIL_PASSWORD, //generate ethereal password
  },
});
            ...
            <tr>
              <td align="center" valign="top" style="padding: 36px 24px;">
                <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVBZHmPz3bXa1h3USI0VHjIjFWfIe8UTEHuvqNfkCI8g&s" alt="Logo" border="0" width="48" >
                </a>
              </td>
            </tr>
          </table>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
              <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="ankitbisen751@gmail.com">Contact us</a>.</p>
              </td>
            </tr>
            <!-- end copy -->
          ...
          <table align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            <tr>
              <td align="center" valign="top" style="font-size: 0; border-bottom: 3px solid #d4dadf">
                ...
                <td align="left" valign="top" width="300">
                <![endif]-->
                <div style="display: inline-block; width: 100%; max-width: 50%; min-width: 240px; vertical-align: top; float: left;">
